class Solution {
    public void find(String digits,int idx,StringBuilder diary,List<String> res, HashMap<Character,String> map){
        ...
        for(int j = 0; j < choice.length(); j++){
            ...
            find(digits,idx + 1,diary,res,map);
